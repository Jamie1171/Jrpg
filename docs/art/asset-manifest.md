...
vertex data. The separate ore asset introduced in 0.2.2 uses a Meshy-generated textured mesh; see below.
...
## Iron ore outcrop (0.2.2)

`game/assets/models/ore/IronOre.glb`: generated by Jamie using Meshy 6 Lite, Free plan, CC BY 4.0. Mesh and texture modified in Blender. Full attribution, source filename, measured sizes and reproduction steps are in the [asset trial report](../production/iron-ore-asset-trial.md).
