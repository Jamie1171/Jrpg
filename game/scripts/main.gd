...
func show_title() -> void:
	...
	text_at(overlay,"OPENING PROTOTYPE  •  0.2.2  •  OFFLINE",Rect2(58,660,530,30),16,MUTED)
	update_music()
...
func show_credits() -> void:
	show_notice("The people behind the dawn","Created for Jamie’s JRPG project.\n\nStory, implementation, original music and art direction developed with OpenAI Codex. Original 3D characters, skeletons, animations and modular scenery built in Blender. Portraits render these same models in Godot.\n\nBuilt with Godot Engine 4.5.1 (MIT). Interface headings use DejaVu Serif (Bitstream Vera / DejaVu licence). Iron outcrop: generated by Jamie with Meshy, CC BY 4.0 (https://creativecommons.org/licenses/by/4.0/); geometry and texture adapted in Blender. Full notices are in the repository.\n\nThis is an original work inspired by a love of classic role-playing games. Opening prototype 0.2.2.",show_menu)
